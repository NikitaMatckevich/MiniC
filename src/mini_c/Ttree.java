...
class Structure {
	...
	public boolean equals(Object other) {
		return other instanceof Structure &&
				((Structure)other).str_name == str_name;	
	}
	
	@Override
	public int hashCode() {
		return str_name.hashCode();
	}
}
...
class Decl_var {
	...
	@Override
	public boolean equals(Object other) {
		return other instanceof Decl_var &&
				((Decl_var)other).name == name;
...
class Decl_fun {
	...
	@Override
	public boolean equals(Object other) {
		return other instanceof Decl_fun &&
			((Decl_fun)other).fun_name == fun_name;
	}
		
	@Override
	public int hashCode() {
		return fun_name.hashCode();
	}
}
